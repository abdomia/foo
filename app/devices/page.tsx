    ...
    <MainLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-text-primary">إدارة الأجهزة</h1>
            <p className="text-text-secondary mt-1">راجع الأجهزة التي دخلت منها إلى حسابك وتحكم فيها</p>
          </div>
        ...
        {message && (
          <div className="bg-primary/10 border border-primary/20 text-text-primary rounded-xl p-4 text-sm flex items-center gap-2">
